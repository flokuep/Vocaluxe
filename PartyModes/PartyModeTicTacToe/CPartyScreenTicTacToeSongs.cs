...
namespace VocaluxeLib.PartyModes.TicTacToe
{
    class CPartyScreenTicTacToeSongs : CMenuPartySongSelection
    {
        ...
        public override void OnShow()
        {
            ...
            SongMode = _PartyMode.GameData.SongMode;
        ...
        protected override void _SetAllowedOptions()
        {
            ...
            AllowedSongModes = new ESongMode[] { ESongMode.TR_SONGMODE_NORMAL, ESongMode.TR_SONGMODE_SHORTSONG, ESongMode.TR_SONGMODE_MEDLEY };
        }
        ...
        private void _SaveConfig()
        {
            ...
            _PartyMode.GameData.SongMode = SongMode;
