...
namespace VocaluxeLib.Menu
{
    public abstract class CMenuPartySongSelection : CMenuParty
    {
        ...
        protected ESongMode[] AllowedSongModes;
        ...
        {
            _SelectSlides[_SelectSlideNumMedleySongs].Visible = SongMode == ESongMode.TR_SONGMODE_MEDLEY;
        ...
        {
            AllowedSongModes = (ESongMode[])Enum.GetValues(typeof(ESongMode));
